            ...
            '/div
                ...
                [
                    ...
                    /following-sibling::span
                        [@class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border-y border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600 rounded-e-lg border-e"]
                        [.="%"]
                ]
            '
        );
